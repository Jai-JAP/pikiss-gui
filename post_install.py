...
#    print('echo -en "\\x1b[1;92mPress [ENTER] to continue.\\x1b[0m" ; read -p ""\n', file=f)
    print('disabled_apps=$(grep \'[[:blank:]]\#\' ~/piKiss/piKiss.sh | awk \'{print $2}\' | tr \'\\n\' \'|\' | sed \'s/|$//\')\n', file=f)
    ...
    print('    sed -r \'s/.\/scripts/~\/piKiss\/scripts/g\' | tr -d \';\' | grep -v uninstall_pikiss | grep -v -E "$disabled_apps" | ', file=f)
